...
from robots.body_layouts import X200_ARM_INIT_POS, X200_ARM_JOINT_NAMES, X200_TORSO_INIT_POS
from robots.hand_layouts import X200_ALL_HAND_JOINT_NAMES, X200_HAND_INIT_POS
import os
...
G129_CFG_WITH_X200_HAND = G129_CFG_WITH_INSPIRE_HAND.replace(
    spawn=G129_CFG_WITH_INSPIRE_HAND.spawn.replace(
        usd_path=f"{project_root}/assets/robots/x200-11-03-base-fix/usd/x200-11-03-base-fix.usd",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.75),
        joint_pos={
    ...
    actuators={
        "legs": G129_CFG_WITH_INSPIRE_HAND.actuators["legs"],
        "torso": ImplicitActuatorCfg(
            joint_names_expr=["torso_joint"],
            effort_limit=1000.0,
            velocity_limit=0.0,
            stiffness={"torso_joint": 10000.0},
            damping={"torso_joint": 10000.0},
            armature=None,
        ),
        "feet": G129_CFG_WITH_INSPIRE_HAND.actuators["feet"],
        "arms": ImplicitActuatorCfg(
            joint_names_expr=X200_ARM_JOINT_NAMES,
            effort_limit={
            ...
            velocity_limit={
                ".*_shoulder_.*_joint": 35.0,
                ".*_elbow_joint": 30.0,
                ".*_wrist_roll_joint": 25.0,
            },
            stiffness={
                ".*_shoulder_.*_joint": 60.0,
                ".*_elbow_joint": 80.0,
                ".*_wrist_roll_joint": 70.0,
            },
            damping={
        ...
        "hands": ImplicitActuatorCfg(
            joint_names_expr=X200_ALL_HAND_JOINT_NAMES,
            effort_limit=100.0,
            velocity_limit=50.0,
            stiffness=1000.0,
            damping=15.0,
