...
class ObjectTableSceneCfg(TableCylinderSceneCfg):
    ...
    robot: ArticulationCfg = G1RobotPresets.g1_29dof_x200_base_fix()


    # 6. add camera configuration 
    front_camera = CameraPresets.x200_front_camera()
    left_wrist_camera = CameraPresets.left_x200_wrist_camera()
    right_wrist_camera = CameraPresets.right_x200_wrist_camera()
