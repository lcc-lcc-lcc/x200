...
class HandType(Enum):
    ...
    X200_HAND = "../assets/x200-11-03/x200_hand.yml"
    X200_HAND_Unit_Test = "../../assets/x200-11-03/x200_hand.yml"
...
class HandRetargeting:
    def __init__(self, hand_type: HandType):
        if hand_type == HandType.UNITREE_DEX3:
            ...
            RetargetingConfig.set_default_urdf_dir("../../assets")
        elif hand_type == HandType.X200_HAND:
            RetargetingConfig.set_default_urdf_dir("../assets")
        elif hand_type == HandType.X200_HAND_Unit_Test:
            RetargetingConfig.set_default_urdf_dir("../../assets")
        ...
        try:
            ...
            if hand_type == HandType.UNITREE_DEX3 or hand_type == HandType.UNITREE_DEX3_Unit_Test:
                # Sort by Unitree dex3 message structure.
                ...
                # Joint order follows the Inspire DFX motor sequence.
                ...
                # Driver motor order follows the BrainCo documentation.
            ...
            elif hand_type == HandType.X200_HAND or hand_type == HandType.X200_HAND_Unit_Test:
                # Joint order follows the Inspire DFX motor semantics using the x200 joint names.
                self.left_x200_api_joint_names = ["l_pinky_mcp_pitch", "l_ring_mcp_pitch", "l_middle_mcp_pitch",
                                                  "l_index_mcp_pitch", "l_thumb_cmc_pitch", "l_thumb_cmc_yaw"]
                self.right_x200_api_joint_names = ["r_pinky_mcp_pitch", "r_ring_mcp_pitch", "r_middle_mcp_pitch",
                                                   "r_index_mcp_pitch", "r_thumb_cmc_pitch", "r_thumb_cmc_yaw"]
                self.left_dex_retargeting_to_hardware = [self.left_retargeting_joint_names.index(name) for name in self.left_x200_api_joint_names]
                self.right_dex_retargeting_to_hardware = [self.right_retargeting_joint_names.index(name) for name in self.right_x200_api_joint_names]
